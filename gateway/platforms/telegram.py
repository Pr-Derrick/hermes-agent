...
class TelegramAdapter(BasePlatformAdapter):
    ...
    async def _handle_polling_conflict(self, error: Exception) -> None:
        ...
        message = (
            ...
            "and restart with 'hermes start'." % MAX_CONFLICT_RETRIES
        )
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            if fallback_ips and not proxy_configured and not disable_fallback:
                ...
                if proxy_configured:
                    logger.info(
                        "[%s] Proxy configured; skipping Telegram fallback-IP transport",
                        self.name,
                    )
    ...
    async def send_exec_approval(
        ...
        try:
            ...
            thread_id = None
            if metadata:
                thread_id = metadata.get("thread_id") or metadata.get(
                    "message_thread_id"
                )
